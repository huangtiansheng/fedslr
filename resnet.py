...
class ResNet(nn.Module):
    ...
    def __init__(self, block, num_blocks, class_num=10,first_layer_output=False):
        ...
        # self.linear2 = nn.Linear(10000, 100, bias=False)
...
def customized_resnet18_k11(pretrained: bool = False, class_num=10,first_layer_output=False,progress: bool = True) -> ResNet:
    res18 = ResNet(BasicBlock, [2, 2, 2, 2],class_num=class_num,first_layer_output=first_layer_output)

    res18.conv1 = nn.Conv2d(3, 64, kernel_size=11, stride=1, padding=1, bias=False)
    # Change BN to GN
    ...
    res18.layer2[0].shortcut[1] = nn.GroupNorm(num_groups=2, num_channels=128)
    ...
    res18.layer3[0].shortcut[1] = nn.GroupNorm(num_groups=2, num_channels=256)
    ...
    res18.layer4[0].shortcut[1] = nn.GroupNorm(num_groups=2, num_channels=512)
...
def customized_resnet18(pretrained: bool = False, class_num=10,first_layer_output=False,progress: bool = True) -> ResNet:
    res18 = ResNet(BasicBlock, [2, 2, 2, 2],class_num=class_num,first_layer_output=first_layer_output)
